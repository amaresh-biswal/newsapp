        ...
        return (
            <div className="container my-3">
                ...
                <div className="container d-flex justify-content-between">
                    ...
                    <button type="button" disabled={this.state.page + 1 > Math.ceil(this.state.totalResults / 9)} className="btn btn-dark" onClick={this.handleNxtClk} >Next &rarr;</button>
                </div>
            </div>
        )
    }
